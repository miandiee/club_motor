      ...
      <div class="container">
         <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
               <img class="bi me-2" src="images/logo2.png" alt="logo" width="50" height="42" role="img">
            </a>
            ...
            <div class="ms-auto">
               <a href="login.php" class="btn btn-outline-warning me-2 pull-right" role="button">Login</a>
            </div>
         </div>
      </div>
   </header>
